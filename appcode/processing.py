...
def gpol(year, country, material, indicator):
      ...
      trade_denom = prodata.at[(year, material),
                              country_name]+trade.at[(year, material, 
                                                      country), 0]
      ...
      if 839 in t.index:
            ...
            weightedsupply = t.loc[:, indicator].mul(t.loc[:, "Amount"].reindex())
      ...
      fin_trade = t[indicator].mul(adj_trade, axis=0)
...
def timeplot(material, country, indicator):
      x = [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017]
      y1 = (gpol(2008, country, material, "WGI Score"), gpol(2009, country, material, "WGI Score"), 
      gpol(2010, country, material, "WGI Score"), gpol(2011, country, material, "WGI Score"), 
      gpol(2012, country, material, "WGI Score"), gpol(2013, country, material, "WGI Score"), 
      gpol(2014, country, material, "WGI Score"), gpol(2015, country, material, "WGI Score"), 
      gpol(2016, country, material, "WGI Score"), gpol(2017, country, material, "WGI Score"))
      y2 = (gpol(2008, country, material, "HDI Score"), gpol(2009, country, material, "HDI Score"), 
      gpol(2010, country, material, "HDI Score"), gpol(2011, country, material, "HDI Score"), 
      gpol(2012, country, material, "HDI Score"), gpol(2013, country, material, "HDI Score"), 
      gpol(2014, country, material, "HDI Score"), gpol(2015, country, material, "HDI Score"), 
      gpol(2016, country, material, "HDI Score"), gpol(2017, country, material, "HDI Score"))
...
def allgpsr(material, year, indicator):
      eu = gpol(year, 97, material, indicator)
      usa = gpol(year, 842, material, indicator)
      jap = gpol(year, 392, material, indicator)
